...
def projmat2rectify(P1, P2, imsize, disp=0):
    """
...
def askpoints(image1, image2):
    ...
    points1 = matarray(np.array(points1).T, None, np.ones((1, num_points)))
    points2 = matarray(np.array(points2).T, None, np.ones((1, num_points)))
